...
/**
 * AdminPromotionConfigsValidKeys200Response Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotionConfigsValidKeys200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotion_configs_valid_keys_200_response';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'result' => 'string',
        'valid_keys' => '\IdpluggerPromotionAdmin\Model\AdminPromotionConfigsValidKeys200ResponseValidKeysInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('valid_keys', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets valid_keys
     *
     * @return \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsValidKeys200ResponseValidKeysInner[]|null
     */
    public function getValidKeys()
    {
        return $this->container['valid_keys'];
    }

    /**
     * Sets valid_keys
     *
     * @param \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsValidKeys200ResponseValidKeysInner[]|null $valid_keys valid_keys
     *
     * @return self
     */
    public function setValidKeys($valid_keys)
    {
        if (is_null($valid_keys)) {
            throw new \InvalidArgumentException('non-nullable valid_keys cannot be null');
        }
        $this->container['valid_keys'] = $valid_keys;
