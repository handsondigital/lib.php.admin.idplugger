...
/**
 * AdminPromotionConfigsStoreRequest Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotionConfigsStoreRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotion_configs_store_request';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key Chave da configuração (deve estar no ConfigKeyEnum)
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value Valor da configuração (string, object ou array - será encodado se type for json)
     *
     * @return self
     */
