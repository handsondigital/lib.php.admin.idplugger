...
/**
 * AdminUsersList200ResponseUsersInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminUsersList200ResponseUsersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_users_list_200_response_users_inner';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'role' => 'string',
        'permissions' => '\IdpluggerPromotionAdmin\Model\AdminServiceCustomerApplications200ResponseContentInnerWorkflowSchedulesInnerWorkflow[]'
    ];
    ...
    */
     ...
     * Sets permissions
     *
     * @param \IdpluggerPromotionAdmin\Model\AdminServiceCustomerApplications200ResponseContentInnerWorkflowSchedulesInnerWorkflow[]|null $permissions Incluído apenas se _include=permissions
     *
     * @return self
     */
