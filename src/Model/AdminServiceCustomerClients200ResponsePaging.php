...
/**
 * AdminServiceCustomerClients200ResponsePaging Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminServiceCustomerClients200ResponsePaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_service_customer_clients_200_response_paging';
