...
/**
 * UserGrantPermissions200ResponseUserInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class UserGrantPermissions200ResponseUserInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_grantPermissions_200_response_user_inner';
