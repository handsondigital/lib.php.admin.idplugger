...
class ApiLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('http_version', $data ?? [], null);
    ...
    */
     ...
     * Sets http_version
     *
     * @param string|null $http_version http_version
     *
     * @return self
     */
    public function setHttpVersion($http_version)
    {
        if (is_null($http_version)) {
            throw new \InvalidArgumentException('non-nullable http_version cannot be null');
        }
    ...
    public function setApiUsername($api_username)
    {
        if (is_null($api_username)) {
            array_push($this->openAPINullablesSetToNull, 'api_username');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('api_username', $nullablesSetToNull);
            if ($index !== FALSE) {
