...
/**
 * ApiLogPaginated Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class ApiLogPaginated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiLogPaginated';
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'content' => '\IdpluggerPromotionAdmin\Model\ApiLog[]',
    ...
    */
     ...
     * Gets content
     *
     * @return \IdpluggerPromotionAdmin\Model\ApiLog[]|null
     */
     ...
     * Sets content
     *
     * @param \IdpluggerPromotionAdmin\Model\ApiLog[]|null $content content
     *
     * @return self
     */
