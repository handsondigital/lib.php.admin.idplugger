...
/**
 * AdminPromotionConfigsShow200ResponseConfig Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotionConfigsShow200ResponseConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotion_configs_show_200_response_config';
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'grupo' => 'string',
        'metadata' => '\IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValueMetadata',
        'dto' => 'object',
        'labels' => 'object'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('grupo', $data ?? [], null);
        $this->setIfExists('metadata', $data ?? [], null);
        $this->setIfExists('dto', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($grupo)) {
            array_push($this->openAPINullablesSetToNull, 'grupo');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('grupo', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['grupo'] = $grupo;
     ...
     * Gets metadata
     *
     * @return \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValueMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValueMetadata|null $metadata metadata
     *
     * @return self
     */
     ...
     * Sets dto
     *
     * @param object|null $dto Estrutura DTO tipada da configuração (se disponível)
     *
     * @return self
     */
    ...
    {
        if (is_null($dto)) {
            array_push($this->openAPINullablesSetToNull, 'dto');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dto', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets labels
     *
     * @param object|null $labels Labels dos campos do DTO (se disponível)
     *
     * @return self
     */
