...
/**
 * AdminPromotionConfigsUpsert200Response Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotionConfigsUpsert200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotion_configs_upsert_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'result' => 'string',
        'message' => 'string',
        'config' => '\IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValue'
    ];
    ...
    */
     ...
     * Gets config
     *
     * @return \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValue|null
     */
     ...
     * Sets config
     *
     * @param \IdpluggerPromotionAdmin\Model\AdminPromotionConfigsIndex200ResponseConfigsValue|null $config config
     *
     * @return self
     */
