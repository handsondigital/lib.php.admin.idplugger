...
/**
 * UserResetPasswordRequest Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class UserResetPasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_resetPassword_request';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username Username do usuário (use username OU email)
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Email do usuário (use username OU email)
     *
     * @return self
     */
