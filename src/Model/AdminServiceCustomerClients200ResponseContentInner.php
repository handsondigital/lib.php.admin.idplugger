...
/**
 * AdminServiceCustomerClients200ResponseContentInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminServiceCustomerClients200ResponseContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_service_customer_clients_200_response_content_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cnpj_cpf', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['cnpj_cpf'];
    }

    /**
     * Sets cnpj_cpf
     *
     * @param string|null $cnpj_cpf cnpj_cpf
     *
     * @return self
     */
    ...
    {
        if (is_null($cnpj_cpf)) {
            throw new \InvalidArgumentException('non-nullable cnpj_cpf cannot be null');
        }
        $this->container['cnpj_cpf'] = $cnpj_cpf;
