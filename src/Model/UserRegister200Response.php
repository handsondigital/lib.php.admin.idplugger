...
class UserRegister200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'result' => 'string',
        'message' => 'string',
        'user' => '\IdpluggerPromotionAdmin\Model\UserRegister200ResponseUser'
    ];
    ...
    */
     ...
     * Gets user
     *
     * @return \IdpluggerPromotionAdmin\Model\UserRegister200ResponseUser|null
     */
     ...
     * Sets user
     *
     * @param \IdpluggerPromotionAdmin\Model\UserRegister200ResponseUser|null $user user
     *
     * @return self
     */
