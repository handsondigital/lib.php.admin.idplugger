...
class UserRegister200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'result' => 'string',
        'message' => 'string',
        'user' => '\IdpluggerPromotion\Model\UserRegister200ResponseUserInner[]'
    ];
    ...
    */
     ...
     * Gets user
     *
     * @return \IdpluggerPromotion\Model\UserRegister200ResponseUserInner[]|null
     */
     ...
     * Sets user
     *
     * @param \IdpluggerPromotion\Model\UserRegister200ResponseUserInner[]|null $user user
     *
     * @return self
     */
