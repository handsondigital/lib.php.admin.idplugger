 ...
 */
class UserGrantPermissions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_grantPermissions_200_response';
