...
/**
 * AdminPromotionConfigsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotionConfigsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotion_configs_update_request';
    ...
    */
     ...
     * Sets value
     *
     * @param mixed|null $value Novo valor da configuração (string, object ou array - será encodado se type for json)
     *
     * @return self
     */
