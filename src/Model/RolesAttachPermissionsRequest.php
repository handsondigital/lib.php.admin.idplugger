...
/**
 * RolesAttachPermissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class RolesAttachPermissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'roles_attachPermissions_request';
