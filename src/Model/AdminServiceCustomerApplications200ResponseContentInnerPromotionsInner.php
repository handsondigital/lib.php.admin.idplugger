...
/**
 * AdminServiceCustomerApplications200ResponseContentInnerPromotionsInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
 ...
 */
class AdminServiceCustomerApplications200ResponseContentInnerPromotionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_service_customer_applications_200_response_content_inner_promotions_inner';
    ...
    protected static array $openAPINullables = [
        ...
        'start_date' => false,
        'end_date' => false,
        'start_delivery_date' => true,
        'end_delivery_date' => true
    ];
    ...
    protected static $setters = [
        ...
        'end_date' => 'setEndDate',
        'start_delivery_date' => 'setStartDeliveryDate',
        'end_delivery_date' => 'setEndDeliveryDate'
    ];
    ...
    protected static $getters = [
        ...
        'end_date' => 'getEndDate',
        'start_delivery_date' => 'getStartDeliveryDate',
        'end_delivery_date' => 'getEndDeliveryDate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('start_delivery_date', $data ?? [], null);
        $this->setIfExists('end_delivery_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets promotion_name
     *
     * @param string|null $promotion_name promotion_name
     *
     * @return self
     */
    ...
    /**
     * Gets start_delivery_date
     *
     * @return string|null
     */
    public function getStartDeliveryDate()
    {
        return $this->container['start_delivery_date'];
    }

    /**
     * Sets start_delivery_date
     *
     * @param string|null $start_delivery_date start_delivery_date
     *
     * @return self
     */
    public function setStartDeliveryDate($start_delivery_date)
    {
        if (is_null($start_delivery_date)) {
            array_push($this->openAPINullablesSetToNull, 'start_delivery_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_delivery_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['start_delivery_date'] = $start_delivery_date;

        return $this;
    }

    /**
     * Gets end_delivery_date
     *
     * @return string|null
     */
    public function getEndDeliveryDate()
    {
        return $this->container['end_delivery_date'];
    }

    /**
     * Sets end_delivery_date
     *
     * @param string|null $end_delivery_date end_delivery_date
     *
     * @return self
     */
    public function setEndDeliveryDate($end_delivery_date)
    {
        if (is_null($end_delivery_date)) {
            array_push($this->openAPINullablesSetToNull, 'end_delivery_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('end_delivery_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['end_delivery_date'] = $end_delivery_date;
