...
/**
 * ErrorReportsApi Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotionAdmin
 * @author   OpenAPI Generator team
...
class ErrorReportsApi
{
    ...
    /**
     * Operation adminErrorsGet
     *
     * List error reports
     *
     * @param  string|null $q Search through id, message, exception class, file (optional)
     * @param  string|null $class Filter by exception class (optional)
     * @param  \DateTime|null $date Filter by date (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminErrorsGet'] to see the possible values for this operation
     *
     ...
     * @return \IdpluggerPromotionAdmin\Model\ErrorReportPaginated
     */
    public function adminErrorsGet($q = null, $class = null, $date = null, $page = 1, $_per_page = 15, string $contentType = self::contentTypes['adminErrorsGet'][0])
    {
        list($response) = $this->adminErrorsGetWithHttpInfo($q, $class, $date, $page, $_per_page, $contentType);
        return $response;
    }

    /**
     * Operation adminErrorsGetWithHttpInfo
     *
     * List error reports
     *
     * @param  string|null $q Search through id, message, exception class, file (optional)
     ...
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotionAdmin\Model\ErrorReportPaginated, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminErrorsGetWithHttpInfo($q = null, $class = null, $date = null, $page = 1, $_per_page = 15, string $contentType = self::contentTypes['adminErrorsGet'][0])
    {
        $request = $this->adminErrorsGetRequest($q, $class, $date, $page, $_per_page, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotionAdmin\Model\ErrorReportPaginated',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function adminErrorsGetAsync($q = null, $class = null, $date = null, $page = 1, $_per_page = 15, string $contentType = self::contentTypes['adminErrorsGet'][0])
    {
        return $this->adminErrorsGetAsyncWithHttpInfo($q, $class, $date, $page, $_per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminErrorsGetAsyncWithHttpInfo
     *
     * List error reports
     *
     * @param  string|null $q Search through id, message, exception class, file (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminErrorsGetAsyncWithHttpInfo($q = null, $class = null, $date = null, $page = 1, $_per_page = 15, string $contentType = self::contentTypes['adminErrorsGet'][0])
    {
        $returnType = '\IdpluggerPromotionAdmin\Model\ErrorReportPaginated';
        $request = $this->adminErrorsGetRequest($q, $class, $date, $page, $_per_page, $contentType);
    ...
    /**
     * Create request for operation 'adminErrorsGet'
     *
     * @param  string|null $q Search through id, message, exception class, file (optional)
     * @param  string|null $class Filter by exception class (optional)
     * @param  \DateTime|null $date Filter by date (optional)
     ...
     */
    public function adminErrorsGetRequest($q = null, $class = null, $date = null, $page = 1, $_per_page = 15, string $contentType = self::contentTypes['adminErrorsGet'][0])
    {
    ...
    /**
     * Operation adminErrorsIdDelete
     *
     * Delete error report
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminErrorsIdDelete'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotionAdmin\Model\SuccessResponse|\IdpluggerPromotionAdmin\Model\ErrorResponse
     */
    public function adminErrorsIdDelete($id, string $contentType = self::contentTypes['adminErrorsIdDelete'][0])
    {
        list($response) = $this->adminErrorsIdDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation adminErrorsIdDeleteWithHttpInfo
     *
     * Delete error report
     *
     ...
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotionAdmin\Model\SuccessResponse|\IdpluggerPromotionAdmin\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminErrorsIdDeleteWithHttpInfo($id, string $contentType = self::contentTypes['adminErrorsIdDelete'][0])
    {
        $request = $this->adminErrorsIdDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotionAdmin\Model\SuccessResponse',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation adminErrorsIdDeleteAsync
     *
     * Delete error report
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminErrorsIdDeleteAsync($id, string $contentType = self::contentTypes['adminErrorsIdDelete'][0])
    {
        return $this->adminErrorsIdDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminErrorsIdDeleteAsyncWithHttpInfo
     *
     * Delete error report
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminErrorsIdDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['adminErrorsIdDelete'][0])
    {
        $returnType = '\IdpluggerPromotionAdmin\Model\SuccessResponse';
        $request = $this->adminErrorsIdDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'adminErrorsIdDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminErrorsIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminErrorsIdDeleteRequest($id, string $contentType = self::contentTypes['adminErrorsIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling adminErrorsIdDelete'
            );
        }


        $resourcePath = '/admin/errors/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation adminErrorsIdGet
     *
     * Get specific error report
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminErrorsIdGet'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotionAdmin\Model\ErrorReport|\IdpluggerPromotionAdmin\Model\ErrorResponse
     */
    public function adminErrorsIdGet($id, string $contentType = self::contentTypes['adminErrorsIdGet'][0])
    {
        list($response) = $this->adminErrorsIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation adminErrorsIdGetWithHttpInfo
     *
     * Get specific error report
     *
     * @param  string $id (required)
     ...
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotionAdmin\Model\ErrorReport|\IdpluggerPromotionAdmin\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminErrorsIdGetWithHttpInfo($id, string $contentType = self::contentTypes['adminErrorsIdGet'][0])
    {
        $request = $this->adminErrorsIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotionAdmin\Model\ErrorReport',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation adminErrorsIdGetAsync
     *
     * Get specific error report
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminErrorsIdGetAsync($id, string $contentType = self::contentTypes['adminErrorsIdGet'][0])
    {
        return $this->adminErrorsIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminErrorsIdGetAsyncWithHttpInfo
     *
     * Get specific error report
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminErrorsIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['adminErrorsIdGet'][0])
    {
        $returnType = '\IdpluggerPromotionAdmin\Model\ErrorReport';
        $request = $this->adminErrorsIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'adminErrorsIdGet'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminErrorsIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminErrorsIdGetRequest($id, string $contentType = self::contentTypes['adminErrorsIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling adminErrorsIdGet'
            );
        }
