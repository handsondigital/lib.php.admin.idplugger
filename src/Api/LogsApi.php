...
class LogsApi
{
    ...
    /**
     * Operation adminLogsIndex
     *
     * Listar logs de requisições da API
     *
     * @param  string|null $path Filtrar por caminho da requisição (optional)
     * @param  string|null $method Filtrar por método HTTP (optional)
     * @param  int|null $status Filtrar por status code (optional)
     * @param  string|null $username Filtrar por username do usuário (optional)
     * @param  \DateTime|null $from Data inicial (YYYY-MM-DD) (optional)
     * @param  \DateTime|null $to Data final (YYYY-MM-DD) (optional)
     * @param  int|null $per_page Itens por página (optional, default to 50)
     * @param  int|null $page Número da página (optional, default to 1)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminLogsIndex'] to see the possible values for this operation
     *
     ...
     * @return \IdpluggerPromotionAdmin\Model\AdminLogsIndex200Response
     */
    public function adminLogsIndex($path = null, $method = null, $status = null, $username = null, $from = null, $to = null, $per_page = 50, $page = 1, string $contentType = self::contentTypes['adminLogsIndex'][0])
    {
        list($response) = $this->adminLogsIndexWithHttpInfo($path, $method, $status, $username, $from, $to, $per_page, $page, $contentType);
        return $response;
    }

    /**
     * Operation adminLogsIndexWithHttpInfo
     *
     * Listar logs de requisições da API
     *
     * @param  string|null $path Filtrar por caminho da requisição (optional)
     ...
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotionAdmin\Model\AdminLogsIndex200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminLogsIndexWithHttpInfo($path = null, $method = null, $status = null, $username = null, $from = null, $to = null, $per_page = 50, $page = 1, string $contentType = self::contentTypes['adminLogsIndex'][0])
    {
        $request = $this->adminLogsIndexRequest($path, $method, $status, $username, $from, $to, $per_page, $page, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotionAdmin\Model\AdminLogsIndex200Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function adminLogsIndexAsync($path = null, $method = null, $status = null, $username = null, $from = null, $to = null, $per_page = 50, $page = 1, string $contentType = self::contentTypes['adminLogsIndex'][0])
    {
        return $this->adminLogsIndexAsyncWithHttpInfo($path, $method, $status, $username, $from, $to, $per_page, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminLogsIndexAsyncWithHttpInfo
     *
     * Listar logs de requisições da API
     *
     * @param  string|null $path Filtrar por caminho da requisição (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminLogsIndexAsyncWithHttpInfo($path = null, $method = null, $status = null, $username = null, $from = null, $to = null, $per_page = 50, $page = 1, string $contentType = self::contentTypes['adminLogsIndex'][0])
    {
        $returnType = '\IdpluggerPromotionAdmin\Model\AdminLogsIndex200Response';
        $request = $this->adminLogsIndexRequest($path, $method, $status, $username, $from, $to, $per_page, $page, $contentType);
    ...
    /**
     * Create request for operation 'adminLogsIndex'
     *
     * @param  string|null $path Filtrar por caminho da requisição (optional)
     * @param  string|null $method Filtrar por método HTTP (optional)
     * @param  int|null $status Filtrar por status code (optional)
     ...
     */
    public function adminLogsIndexRequest($path = null, $method = null, $status = null, $username = null, $from = null, $to = null, $per_page = 50, $page = 1, string $contentType = self::contentTypes['adminLogsIndex'][0])
    {
    ...
    /**
     * Operation adminLogsShow
     *
     * Visualizar log específico
     *
     * @param  int $id ID do log (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminLogsShow'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotionAdmin\Model\AdminLogsShow200Response
     */
    public function adminLogsShow($id, string $contentType = self::contentTypes['adminLogsShow'][0])
    {
        list($response) = $this->adminLogsShowWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation adminLogsShowWithHttpInfo
     *
     * Visualizar log específico
     *
     * @param  int $id ID do log (required)
     ...
     * @throws \IdpluggerPromotionAdmin\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotionAdmin\Model\AdminLogsShow200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminLogsShowWithHttpInfo($id, string $contentType = self::contentTypes['adminLogsShow'][0])
    {
        $request = $this->adminLogsShowRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotionAdmin\Model\AdminLogsShow200Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminLogsShowAsync($id, string $contentType = self::contentTypes['adminLogsShow'][0])
    {
        return $this->adminLogsShowAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminLogsShowAsyncWithHttpInfo
     *
     * Visualizar log específico
     *
     * @param  int $id ID do log (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminLogsShowAsyncWithHttpInfo($id, string $contentType = self::contentTypes['adminLogsShow'][0])
    {
        $returnType = '\IdpluggerPromotionAdmin\Model\AdminLogsShow200Response';
        $request = $this->adminLogsShowRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'adminLogsShow'
     *
     * @param  int $id ID do log (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminLogsShow'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adminLogsShowRequest($id, string $contentType = self::contentTypes['adminLogsShow'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling adminLogsShow'
            );
        }


        $resourcePath = '/v3/admin/logs/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
